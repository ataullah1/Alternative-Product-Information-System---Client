...
const MyQueryCardThree = ({ dta, handleDelete }) => {
  ...
  return (
    <div className="mx-auto min-w-full max-w-[500px] rounded-lg bg-white font-sans shadow-lg dark:bg-[#18181B]">
...
export default MyQueryCardThree;
MyQueryCardThree.propTypes = {
