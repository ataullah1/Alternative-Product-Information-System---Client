const MiddleBanner = () => {
  return (
    <div className="relative mt-32 mb-36 h-[500px] sm:h-[600px] w-full">
      <div
        className="bg-gradient-to-r from-[#0de46eca] to-[#07c8f88b] bg-cover bg-no-repeat bg-bottom h-full w-full"
        style={{
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-[#22342a28] to-[#bef2bc24]">
        <div className="w-11/12 mx-auto h-full flex flex-col justify-center">
          <h1 className="text-3xl sm:text-5xl text-slate-50 max-w-[800px] leading-[1.220]">
